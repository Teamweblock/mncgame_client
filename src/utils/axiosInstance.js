...
export const ConnectMessage = async (payload) => {
  try {
    const response = await axiosInstance.post("/player/connect", payload);
...
export const updatePlayer = async (formData) => {
  try {
    const response = await axiosInstance.put(`/player/update`, formData, {
      headers: {
...
export const gameOverview = async (payload) => {
  try {
    const response = await axiosInstance.post("/player/gameOverview", payload);
    if (response && response?.status === 200) {
      return response.data; // Return the user profile data
    }
    toast.error("Unexpected response from the server.");
...
export const problemPilot = async (payload) => {
  ...
  try {
    const response = await axiosInstance.post("player/problem-pilot", payload);
    if (response && response?.status === 200) {
      return response.data; // Return the user profile data
    }
    toast.error("Unexpected response from the server.");
...
export const strategyTrial = async (payload) => {
  try {
    const response = await axiosInstance.get("/player/strategy-trial", payload);
    if (response && response?.status === 200) {
      return response.data; // Return the user profile data
    }
    toast.error("Unexpected response from the server.");
...
export const overalluserprogress = async (payload) => {
  console.log("payload", payload);

  try {
    const response = await axiosInstance.post(
      "player/overalluserprogress",
      payload
    );
    if (response && response?.status === 200) {
      return response.data; // Return the user profile data
...
export const managementSkills = async (payload) => {
  console.log("payload", payload);

  try {
    const response = await axiosInstance.post(
      "player/managementSkills",
      payload
    );
    if (response && response?.status === 200) {
      return response.data; // Return the user profile data
...
export const getMeetRole = async () => {
  try {
    const response = await axiosInstance.get("/thirdGame/meet/role/all");
