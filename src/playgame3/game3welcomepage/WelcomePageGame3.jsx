...
<img src={icon2} className='icon2-game3' style={{ transform: `translate(${offset.x}px, ${offset.y}px)` }}/>
    <div className='welcome-title'>
        ...
        <button className='game1Playbtn w-100 py-3' style={{ letterSpacing : "2px", fontSize : "20px"}}>Comming Soon...</button>
