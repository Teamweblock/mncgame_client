  ...
  return (
    <>
      <div>
        ...
        <div className="ourmission-group">
        ...
        <div className="position-relative">
          ...
          <div className="whymnc-group">
            <div className="row">
              <div className="col-md-6">
                <h1 className="title-top why-mnc-text">Why MNC?</h1>
                <p className="about-para-text mt-4">
              ...
              <div className="col-md-6">
                <div className="img-center">
                  <img className="about-img2" src={img7} alt="About Image 2" />
                  <img
                    src={image1}
        ...
        <div className="ourservice-group">
