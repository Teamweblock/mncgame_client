        ...
        <div className=" px-10 flex items-center justify-between w-[90%] mx-auto max-lg:justify-center ">
          ...
          <div className="gap-4 flex max-lg:hidden">
            <button
              ...
              className="bg-[#ff5024] w-[200px] hover:bg-white hover:text-[#ff5024] hover:border-[#ff5024] transition delay-300  duration-700 text-slate-50 text-[1.4rem] font-bold rounded-full px-6 py-2 max-md:text-[1.2rem]"
            >
              NEXT LEVEL
            </button>
            <button
        ...
        <div>
          <div className="flex justify-center items-center mx-auto flex-col mt-5">
            ...
            <div className="gap-4 flex  flex-col lg:hidden mt-10 pb-4">
              <button
                className="bg-[#ff5024] w-[200px] hover:bg-white hover:text-[#ff5024] hover:border-[#ff5024] transition delay-300  duration-700  text-white text-[1.4rem] font-bold rounded-full px-6 py-2 max-md:text-[1.2rem]"
                onClick={selectLevelpage}
              >
                NEXT LEVEL
              </button>
