            ...
            <div className="single-player-part">
              ...
              <div className="text-center d-sm-flex flex-sm-wrap justify-content-sm-center">
                {currentQuestionIndex === 0 && (
                  <div className="">
                    <button
                      className="next-button me-md-3 transition delay-300  duration-700"
                      onClick={handleBack}
                    >
                      Back
                    </button>
                ...
                {currentQuestionIndex < playerData?.length - 1 ? (
                  <div className="">
                    <button
                      className="next-button transition delay-300  duration-700"
                  ...
                  <div className="">
                    <button
                      className="show-button text-nowrap transition delay-300  duration-700"
                      onClick={handleNextQuestion}
                    >
                      Show Results
                    </button>
