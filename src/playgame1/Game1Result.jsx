  ...
  return (
    <>
      <div className="Game1-bg-result">
        ...
        />
        <div>
          <h1 className="text-8xl font-bold text-white max-lg:text-4xl text-center lg:my-20 mt-20 py-4 transition duration-500 ease-in-out hover:text-glow  glow-effect">
            WELL DONE
          </h1>
          ...
          <div className="w-[70%] max-lg:w-[90%] mx-auto">
            ...
            <div className="btn-group2 pb-3">
              <button
                className="home-btn  transition duration-700 ease-in-out"
                onClick={handleHome}
              >
                Home
              </button>
              <button
                className="next-btn  transition duration-700 ease-in-out"
